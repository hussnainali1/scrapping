...
def iterate(internal_link):
    ...
    fun_inner_div_3rd = fun_inner_div_2nd.find(
        'div', {'class': 'content-area'})
    fun_inner_div_4th = fun_inner_div_3rd.find('main')
    fun_inner_div_5th = fun_inner_div_4th.find('article')
    fun_inner_div_6th = fun_inner_div_5th.find(
        'div', {'class': 'article-content'})
    fun_inner_div_7th = fun_inner_div_6th.find(
    ...
    fun_inner_div_8th = fun_inner_div_7th.find(
...
def fun_first_section(first_section):
    ...
    fun_div3 = fun_div2.find(
        'div', {'class': 'landing-secondary-main headline-list'})
...
def third_section_triverse(third_section, dic4):
    ...
    fun_div_2nd = fun_div.find_all(
        'section', {'class': 'section-highlight'})

    counter = dic4.__len__()
    for div_loopi in fun_div_2nd:
        fun_div_3rd = div_loopi.find(
...
def fun_second_Section(second_Section_div, dic1):
    inner_div_5th = second_Section_div.find_all(
...
class locala:
    ...
    def mainPro(self):
        ...
        inner_div_5th = inner_div_4th.find(
            'div', {'class': 'homepage section'})
        dic = {}

        # ========== 111

        first_section = inner_div_5th.find(
        ...
        second_section_div = inner_div_5th.find(
        ...
        # ========== 3333
        third_section = inner_div_5th.find(
        ...
        for member in dic3.keys():
            ...
            try:
                insert_post = Scholarship_collection.update(
                    dic3[member], dic3[member], upsert=True)
                print(insert_post)
