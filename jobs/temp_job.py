...
class jobsClass:
    ...
    def mainPro(self):
        ...
        fun_main_article3 = fun_main_article.find(
            'div', {'class': 'container wpjm-container full-width'})
        fun_main_article4 = fun_main_article3.find(
            'article', {'id': 'post-2069'})
        fun_main_article5 = fun_main_article4.find(
            'div', {'class': 'padding-right'})
        fun_main_article6 = fun_main_article5.find(
        ...
        for all_ineer in fun_main_article9:
            ...
            fun_main_article_tiitle_upper = fun_main_article10.find(
            ...
            fun_main_article_logo = fun_main_article10.find(
            ...
            fun_main_article1c = fun_main_article1bb.find(
                'div', {'id': 'mm-1'})
            fun_main_article1cc = fun_main_article1bb.find(
                'div', {'class': 'container right-sidebar'})

            fun_main_article1d = fun_main_article1cc.find(
                'div', {'class': 'padding-right'})
            fun_main_article1e = fun_main_article1d.find(
                'div', {'class': 'single_job_listing'})
            fun_main_article1f = fun_main_article1e.find(
